...
const METRIC_TITLES = {
    ...
    INSERT_1_MESSAGE: 'Insert one one message',
    ...
    MESSAGE_INSERT_TO_MESSAGE_LIST_CHANGE: 'Time from message insert to message list change',
    USER_PAIR_CHANGED_TO_MESSAGE_LIST: 'Time from message insert to user list change',
...
async function run() {
    ...
    metricsFiles
        .filter(fileName => fileName.startsWith('project-'))
        .forEach(fileName => {
